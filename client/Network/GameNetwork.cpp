...
#include "GameNetwork.hh"


sf::Packet &operator<<(sf::Packet &packet, const GosChess::color_t &clr) {
    return packet << static_cast<int>(clr);
}

sf::Packet &operator>>(sf::Packet &packet, GosChess::color_t &clr) {
    int tmp;
    packet >> tmp;
    clr = static_cast<GosChess::color_t>(tmp);
    return packet;
}
...
sf::Packet &operator<<(sf::Packet &packet, const GosChess::action_t &mv) {
    return packet << mv.move_from << mv.move_to;
}

sf::Packet &operator>>(sf::Packet &packet, GosChess::action_t &mv) {
    return packet >> mv.move_from >> mv.move_to;
}
...
sf::Packet &operator<<(sf::Packet &packet, const GosChess::DataTransfer<GosChess::action_t> &dt) {
    return packet << dt.protocol << dt.body;
}

sf::Packet &operator>>(sf::Packet &packet, GosChess::DataTransfer<GosChess::action_t> &dt) {
    return packet >> dt.protocol >> dt.body;
}

sf::Packet &operator<<(sf::Packet &packet, const GosChess::DataTransfer<GosChess::color_t> &dt) {
    return packet << dt.protocol << dt.body;
}

sf::Packet &operator>>(sf::Packet &packet, GosChess::DataTransfer<GosChess::color_t> &dt) {
    return packet >> dt.protocol >> dt.body;
}
...
void GosChess::SendMove(GosChess::action_t move) {
    sf::Packet packet;
...
void GosChess::InitialSend() {
    int n = rand() % 2;
    GosChess::player_color = static_cast<GosChess::color_t>(n);
    GosChess::enemy_color = static_cast<GosChess::color_t>(!n);
    sf::Packet init_info;
...
void GosChess::InitialReceive() {
    ...
    init_info >> req;
    GosChess::player_color = static_cast<GosChess::color_t>(req.body.player_color);
    GosChess::enemy_color = static_cast<GosChess::color_t>(!req.body.player_color);
