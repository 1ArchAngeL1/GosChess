...
unsigned int GosChess::window_height = 1000;

unsigned int GosChess::window_width = 1400;
...
float GosChess::square_size = GosChess::board_width / GosChess::board_t::ROW_NUM;
