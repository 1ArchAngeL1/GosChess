...
struct SFML_GRAPHICS_API BlendMode
{
    ...
    enum Factor
    {
        Zero,             ///< (0, 0, 0, 0)
        One,              ///< (1, 1, 1, 1)
        SrcColor,         ///< (client.r, client.g, client.b, client.a)
        OneMinusSrcColor, ///< (1, 1, 1, 1) - (client.r, client.g, client.b, client.a)
        DstColor,         ///< (dst.r, dst.g, dst.b, dst.a)
        OneMinusDstColor, ///< (1, 1, 1, 1) - (dst.r, dst.g, dst.b, dst.a)
        SrcAlpha,         ///< (client.a, client.a, client.a, client.a)
        OneMinusSrcAlpha, ///< (1, 1, 1, 1) - (client.a, client.a, client.a, client.a)
...
/// to the following formula (\a client is the color of the source pixel, \a dst
/// the color of the destination pixel, the other variables correspond to the
/// public members, with the equations being + or - operators):
/// \code
/// dst.rgb = colorSrcFactor * client.rgb (colorEquation) colorDstFactor * dst.rgb
/// dst.a   = alphaSrcFactor * client.a   (alphaEquation) alphaDstFactor * dst.a
/// \endcode
